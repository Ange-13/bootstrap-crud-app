...
const Registration = () => {
  ...
  function handleOnClick(event: any) {
    ...
    setValuePrintConfirmPass(valuePrintConfirmPass);
  }
  ...
  return (
    <div className="row d-flex justify-content-center align-items-center vh-100 bg-body-secondary">
      ...
      <div className="Printed-text">{valuePrintName}</div>
      <div className="Printed-text">{valuePrintEmail}</div>
      <div className="Printed-text">{valuePrintPass}</div>
      <div className="Printed-text">{valuePrintConfirmPass}</div>
    </div>
  );
};
